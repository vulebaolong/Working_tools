...
`
let html_Erorr = `
    <button type="button" class="btn_Erorr none">
        Erorr
                ...
                Authen_Erorr(url_erorr, 'A', 1)
                    ...
                    .then((e) => {
                        ...
                        if (e === true) {
                            ...
                            `
                            START(S_inhouse, S_order, htmlTeamplate, false)
                        }
                    })
                //===================================   
            } else {
...
function START(S_inhouse, S_order, htmlTeamplate, Authen) {
    //word
    if (S_inhouse != -1 && S_order == -1) {
        ...
        var ele_Auto_inhouse = document.querySelector('.Auto_inhouse')

        //ON-OFF=============================================================================
        var ele_htmlONOFF = document.querySelector('.btn_ONOFF')
        ele_htmlONOFF.onclick = () => {
            ele_Auto_inhouse.classList.toggle('none')
        }
        //ON-OFF=============================================================================


        //Các phần tử trong Auto_inhouse=====================================================
        const item_Auto_inhouse = Array.from(ele_Auto_inhouse.children)

        if (item_Auto_inhouse !== null) {
            item_Auto_inhouse.forEach((e) => {
        ...
        //RIÊNG ERORR =======================================================================
        if (Authen) {
            const btn_Erorr_wrap = Array.from(document.querySelector('.btn_Erorr_wrap').children)

            if (btn_Erorr_wrap !== null) {
                btn_Erorr_wrap.forEach((e) => {
                    switch (e.classList[0]) {
                        case 'btn_Erorr_1':
                            e.onclick = (event) => {
                                event.stopPropagation()
                        ...
                        default:
                            console.log('không được el_btn_Erorr');
                            break;
                    }
                })
            } else {
                console.log('Không tìm thấy el_btn_Erorr')
            }
            ...
            //Ẩn Hiện ===============================================================
            const btn_Erorr = document.querySelector('.btn_Erorr')
            console.log(btn_Erorr);
            document.addEventListener("keydown", function (event) {
                //xem đang nhấn phím gì
                //console.log(event);
                if (event.altKey && event.code === 'KeyO') {
                    btn_Erorr.classList.toggle("none")
                }
            })
            //=======================================================================
        ...
        //RIÊNG SEARCH ======================================================================
        var el_button_search = document.querySelector('.search_button_box')
        var el_search_box = document.querySelector('.search_box')
        var el_in_search_LDP = document.querySelector('.in_search_LDP')
